...
<div class="nhsuk-inset-text">
  ...
  <p>For any queries about how the back navigation in the NHS App will work with your service, email <a href="mailto:app.integration@nhs.net">app.integration@nhs.net</a>.</p>
</div>
