...
<!-- NHS LOGO SERVICES -->
  <h2 id="NHS">I am a service that uses the NHS logo</h2>
        ...
        <p>If your service has NHS branding, but the NHS logo is not on the same screen as the NHS login button, you will need to use <a href="/nhslogin/guidance#other">the version for services that do not use NHS logo</a>.</p>
  <div class="nhsuk-grid-row">
    <div class="nhsuk-grid-column-one-third">
        <div class="code-embed">
