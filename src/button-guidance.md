...
.button-guidance-do-dont .nhsuk-card--feature > .nhsuk-card__content {
  padding: 0 24px 24px;
}
.button-guidance-do-dont .nhsuk-card--feature .nhsuk-card__heading {
...
.button-guidance-do-dont .nhsuk-card--feature .nhsuk-card__heading + .nhsuk-list {
  margin-top: 0;
}
...
/* Reset the earlier NHS frontend's feature-label offsets. */
